...
folder_path = "./OlfactoryProjectionFibers/ImageStacks/OP_9"
...
blend = blended(skel)
single_download(blend, "./Test/Images/OP_9_skel.png")
...
graph.create_graph()
root = graph.get_root()
g_root = (64.56,364.47,4)
print(f"OP_9 GOLD STANDARD ROOT: {g_root}\nTEST ROOT: {root}")

distances, paths = graph.apply_dijkstra_and_label_nodes()

print(len(distances), len(paths))

print("SWC generated:",graph.save_to_swc("./Test/OP_9.swc"))
