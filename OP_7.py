...
folder_path = "./OlfactoryProjectionFibers/ImageStacks/OP_7"
...
blend = blended(skel)
single_download(blend, "./Test/Images/OP_7_skel.png")
...
graph.create_graph()
root = graph.get_root()
g_root = (119.76,215.98,39)
print(f"OP_7 GOLD STANDARD ROOT: {g_root}\nTEST ROOT: {root}")

distances, paths = graph.apply_dijkstra_and_label_nodes()

print(len(distances), len(paths))

print("SWC generated:",graph.save_to_swc("./Test/OP_7.swc"))
